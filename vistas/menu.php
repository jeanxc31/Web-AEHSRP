    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/loginimg.png" alt="" width="200px" height="150px"></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-list-alt"></span> Generar registro <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="categorias.php">Categorias</a></li>
              <li><a href="instituciones.php">Instituciones</a></li>
              <li><a href="articulos.php">Registros</a></li>
            </ul>
          </li>
        ...
        if($_SESSION['usuario']=="admin"):
         ...
         <?php 
          ...
          ?>
           ...
           <li><a href="responsables.php"><span class="glyphicon glyphicon-user"></span> Responsables</a>
          </li>
          <li><a href="ventas.php"><span class="glyphicon glyphicon-signal"></span> Generar Reporte</a>
          </li>
